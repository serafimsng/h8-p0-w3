...
function nilaiKuliah(nama, matkul1, matkul2, matkul3) {
  var rata = (matkul1+matkul2+matkul3)/3
  if(rata >= 80){
  	var grade = 'A'
  	return `Selamat ${nama}, grade kamu adalah ${grade}, Anda adalah lulusan terbaik`
  }else if(rata >= 70 && rata < 80){
  	var grade = 'B'
  	return `Selamat ${nama}, grade kamu adalah ${grade}, Anda adalah lulusan kedua terbaik`
  }else {
  	var grade = 'C'
  	return `${nama}, grade kamu adalah ${grade}, Anda lulus`
  }
}
